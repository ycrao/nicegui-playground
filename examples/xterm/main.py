...
def _page():
    ui.add_css('''
body {
  font-family: 'Ubuntu Mono derivative Powerline', Tahoma, Geneva, Verdana, sans-serif;
  font-size: 12px;
}
.xterm-rows {
    font-family: 'Ubuntu Mono derivative Powerline', courier-new, courier, monospace !important;
}
    ''')
    terminal = ui.xterm()
